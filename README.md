...
running command...
$ genstuff (--version)
genstuff/0.0.0-alpha.7 linux-x64 node-v18.14.2
...
```
USAGE
  $ genstuff gen [COMPONENTNAME] [-p <value>] [-s] [-D] [-f <value>] [-e <value>]
...
_See code: [dist/commands/gen.ts](https://github.com/alexvyber/genstuff/blob/v0.0.0-alpha.7/dist/commands/gen.ts)_
